...
面向 Apple 芯片 Mac 与 macOS 15 及更高版本的轻量级、单进程菜单栏鼠标工具。
...
- 可按应用分别开关 Mousse 滚动优化和反向滚动；仅启用反向时仍保持应用的原生滚动手感。
- 不会修改触控板手势，只处理实体鼠标滚轮。
...
- Apple 芯片 Mac（arm64）。
- macOS 15.0 或更高版本。标准界面会在 macOS 26 及后续版本自动采用对应系统外观。
...
从 [最新版本](https://github.com/Souitou-iop/Mousse/releases/latest) 下载 `Mousse.zip`，解压后将 `Mousse.app`
拖入 **应用程序** 文件夹。
